...
%
% Credits to:
% Stefan Roth, Patrick Doran, Adriana Kovashka
%
% Last edited on 1/9/2020, by Ahmed Dallal
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Scripts enable portability of your codes and make debuging easier
...
% You can log your commands in a diary file if you want to, but you can't
...
addpath 'C:\Users\ahd12\My Documents'
